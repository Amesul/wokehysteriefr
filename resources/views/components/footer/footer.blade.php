<footer {{ $attributes }} class="mt-24 flex py-24 text-white bg-jacarta">
    <div class="ml-auto pr-24">
        <h1 class="text-5xl text-white font-luckiest-guy">La Woke Hystérie</h1>
        <p>© 2022 - 2023 <br>
