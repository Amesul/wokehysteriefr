...
$classes = ($active ?? false)
            ...
            : 'block w-full pl-3 pr-4 py-2 border-l-4 border-transparent text-left text-base font-medium text-gray-600 transition-all duration-300 hover:text-gray-800 transition-all duration-300 hover:bg-gray-50 transition-all duration-300 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out';
@endphp
